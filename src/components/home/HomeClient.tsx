...
const categories = [
  {
    ...
    metric: "12K+ yorum",
    examples: "Hilton, Rixos, Swissôtel...",
  },
  {
    slug: "otobus",
    title: "Otobüs",
...
const featureCards = [
  {
    title: "Güncel Yorum Havuzu",
    description: "Son 12 aydaki geri bildirimleri kaynak bazlı toplar.",
    icon: <Compass className="h-5 w-5" />,
  },
  {
    title: "Net Artı-Eksi Özeti",
    description: "Uzun yorumları okunur ve karşılaştırılabilir hale getirir.",
    icon: <MessageSquareText className="h-5 w-5" />,
  },
  {
    title: "Güven Skoru",
    description: "Eski veya tutarsız yorum etkisini azaltan karar katmanı sunar.",
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col items-start px-4 pt-28 pb-6 md:h-full md:px-6 md:pt-44 md:pb-0">
            <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-slate-950/50 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-cyan-100">
              ...
              <span className="leading-tight">
                <span className="block">Gerçek yorumlarla</span>
                <span className="block">hızlı karar</span>
              </span>
            </div>
            ...
            <div className="mt-5 max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-200 drop-shadow-[0_1px_6px_rgba(0,0,0,0.5)] md:text-lg">
                Otel, restoran, uçak ve otobüs yorumlarını tek ekranda anlayıp dakikalar
                içinde karar ver. Sade, hızlı ve gerçek kullanıcı odaklı.
              </p>
            </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-2 md:px-6 md:pt-12">
        <section id="kategoriler" className="mt-2 md:mt-12">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="text-2xl font-bold text-slate-50 md:text-3xl">Kategori seç ve devam et</h2>
          </div>
        ...
        <section className="mt-12 rounded-3xl border border-cyan-200/25 bg-slate-900/50 p-6 backdrop-blur-xl md:p-8">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border border-slate-700/60 bg-slate-800/80 p-4">
              <p className="text-xs uppercase tracking-wide text-slate-400">Adım 1</p>
              <p className="mt-1 font-semibold text-slate-100">Kategori seç</p>
              <p className="mt-1 text-sm text-slate-300">Otel, restoran, uçak veya otobüs.</p>
            </div>
            <div className="rounded-xl border border-slate-700/60 bg-slate-800/80 p-4">
              <p className="text-xs uppercase tracking-wide text-slate-400">Adım 2</p>
              <p className="mt-1 font-semibold text-slate-100">İşletme adını yaz</p>
              <p className="mt-1 text-sm text-slate-300">Örnek sorgularla tek tıkta dene.</p>
            </div>
            <div className="rounded-xl border border-slate-700/60 bg-slate-800/80 p-4">
              <p className="text-xs uppercase tracking-wide text-slate-400">Adım 3</p>
              <p className="mt-1 font-semibold text-slate-100">Özeti karşılaştır</p>
              <p className="mt-1 text-sm text-slate-300">Artı-eksi tablosu ile hızlı karar ver.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-3xl border border-cyan-200/25 bg-slate-900/50 p-7 backdrop-blur-xl md:p-10">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="text-sm text-slate-300">YorumArat — AI destekli yeni arayüz</p>
            <Link
              href="/otel"
